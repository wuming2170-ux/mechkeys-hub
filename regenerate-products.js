/**
 * Regenerate products using ONLY SerpAPI verified image URLs
 */
const fs = require('fs');
...
const topProducts = top.map(p => {
    ...
    return {
        ...
        image: p.image, // 使用 SerpAPI 返回的原始图片 URL
...
console.log('Generated ' + topProducts.length + ' products with SerpAPI verified images:');
